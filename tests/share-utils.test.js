...
test("createShareData returns normalized title/text/url", () => {
...
test("buildShareTargets returns expected providers and encoded URLs", () => {
...
test("shouldUseNativeShare checks for navigator.share function", () => {
